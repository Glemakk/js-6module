...
// console.log(calculateTotalPrice([1, 3, 5, 6, 8, 9]));
...
// console.log(filterArray([2, 4, 6, 7], 5));
...
// const getUsersWithFriend = (users, friendName) => users.some(friend => friend === friendName);  ==== это для проверки тру или фолс. Не для этой задачи
...
// const isEveryUserActive = (users) => users.every(function(user){
...
// // const totalAveragePlaytimePerGame = players.reduce((total, playerTime) => total + playerTime.playtime / playerTime.gamesPlayed, 0);
...
// const getTotalFriendCount = users => users.reduce((total, friend) => [...total, ...friend.friends], []).length;
...
// const sortedByAuthorName = [...books].sort((firstAuthorName, secondAuthorName) => firstAuthorName.author.localeCompare(secondAuthorName.author));

// const sortedByReversedAuthorName = [...books].sort((firstAuthorName, secondAuthorName) => secondAuthorName.author.localeCompare(firstAuthorName.author));
...
// const sortByAscendingBalance = users => users.sort((firstValue, secondValue) => firstValue.balance - secondValue.balance);


//----------------------------------------------39
/*Дополни функцию sortByDescendingFriendCount(users) так, чтобы она возвращала массив пользователей отсортированный по убыванию количества их друзей (свойство friends).*/

// const sortByDescendingFriendCount = users => [...users].sort((firstPerson, secondPerson) => secondPerson.friends.length - firstPerson.friends.length);
...
// const values = users.flatMap(user => user.balance);
// console.log(values);

// const gender = 'male';
// const filterGender = users.filter(user => user.gender === gender).reduce((total, value) => total + value.balance, 0);
// console.table(filterGender);
// const totalBalance = values.reduce((total, value) => total + value, 0);
// console.log(totalBalance);

const getTotalBalanceByGender = (users, gender) => users.filter(user => user.gender === gender).reduce((total, value) => total + value.balance, 0);
